...
export default function HotelPageLayout(p: HotelPageProps) {
    ...
    const contactLink = `/contact?hotel=${encodeURIComponent(p.name)}&targetPhone=${p.waPhone}&msg=${encodeURIComponent(p.waMsg)}`
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pb-16 sm:pb-24">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <button 
                                ...
                                className="wa-btn text-base px-10 py-4 shadow-[0_8px_32px_rgba(212,175,55,0.3)] bg-gradient-to-r from-gold-400 to-gold-600 border-0"
                            >
                                <Zap className="w-5 h-5" /> Book Now
                            </button>
                            <Link 
                                href={contactLink} 
                                className="gold-btn text-base px-8 py-4 bg-navy-900/40 backdrop-blur"
                            >
                                <WA /> WhatsApp
                            </Link>
                        </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                        {p.roomTypes.map(({ icon, title, desc }) => (
                            <div key={title} className="luxury-card p-8 flex flex-col gap-5">
                                ...
                                <Link href={contactLink} className="wa-btn text-sm py-3 mt-1">
            ...
            <section className="bg-navy-950 py-20 sm:py-28 relative overflow-hidden">
                ...
                <div className="max-w-3xl mx-auto px-4 text-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                        <Link 
                            href={contactLink} 
                            className="wa-btn text-base px-8 py-4 shadow-[0_8px_32px_rgba(37,211,102,0.3)]"
                        >
