            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-16 sm:mb-20">
                    ...
                    <p className="text-white/55 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
                        Each property crafted for your unique travel need — corporate efficiency,
                        family warmth, or budget comfort — all in the heart of Visakhapatnam.
                    </p>
                </div>
                ...
                <div className="mt-12 text-center">
                    ...
                    <a
                        href={`https://wa.me/919676247755?text=${encodeURIComponent(
                            "Hello! I need some help choosing the right KGB Hotel for my stay in Visakhapatnam. Could you guide me based on my requirements? Thank you!"
                        )}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="wa-btn inline-flex text-sm px-6 py-3"
                    >
                        <svg
                            className="w-4 h-4"
                            fill="currentColor"
