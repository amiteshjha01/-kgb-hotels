...
export default function Footer() {
    ...
    const hotels = [
        ...
        { name: "KGB Legend Grand", href: "/hotel/legend-grand", phones: ["9000907755", "9666587755"], wa: "9000907755", maps: "https://maps.app.goo.gl/BLPF3ahn7erbB4LM9" },
        { name: "KGB Villa Homes", href: "/hotel/villa-homes", phones: ["9666597755", "8367214304"], wa: "9666597755", maps: "https://maps.app.goo.gl/jt8CG54gUyHdtVpT9" },
    ]

    const navLinks = [
        { href: "/", label: "Home" }, { href: "/hotel/cool-river", label: "KGB Coolriver" },
        { href: "/hotel/legend-grand", label: "KGB Legend Grand" }, { href: "/hotel/villa-homes", label: "KGB Villa Homes" },
