        ...
        <section className="relative w-full overflow-hidden min-h-screen flex items-center justify-center">
            ...
            <HeroAnimator>
                <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center pt-28 pb-20">
                    ...
                    {/* Heading */}
                    <h1 className="font-serif mb-6 leading-[1.08] hero-fade d1"
                    ...
                    {/* Ornament */}
                    <div className="flex justify-center mb-6 hero-fade d2">
                    ...
                    {/* Subtext */}
                    <p className="text-base sm:text-lg md:text-xl font-light leading-relaxed text-white/70 max-w-2xl mx-auto mb-10 hero-fade d3">
                    ...
                    {/* Location pills */}
                    <div className="flex flex-wrap justify-center gap-2.5 mb-10 hero-fade d4">
                    ...
                    {/* CTAs */}
                    <div className="flex flex-col sm:flex-row gap-4 justify-center mb-14 hero-fade d5">
                    ...
                    {/* Stats */}
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-xl mx-auto hero-fade d6">
